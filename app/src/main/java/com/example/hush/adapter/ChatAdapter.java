...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ChatHolder> {
    ...
    static class ChatHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView leftChat;
        private final TextView rightChat;

        public ChatHolder(@NonNull View itemView) {
            super(itemView);

            leftChat = itemView.findViewById(R.id.leftChat_chat_items);
            rightChat = itemView.findViewById(R.id.rightChat_chat_items);
